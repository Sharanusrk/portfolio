...
const socialLinks = [
  { icon: FaGithub, href: 'https://github.com/sharanusrk' },
  { icon: FaLinkedin, href: 'https://www.linkedin.com/in/sharanu-kumusagi' },
  { icon: FaInstagram, href: 'https://www.instagram.com/sharanu_srk?igsh=MXBvNzBqdWw1ZjlpZA==' },
];
